...
from remediation_handler import handle_remediate_cve
...
AVAILABLE_FUNCTIONS = ['query_vulnerabilities', 'list_projects', 'query_tickets', 'list_ticket_projects', 'remediate_cve']
