...
ENV_VARS="{\"SLACK_BOT_TOKEN\":\"$SLACK_BOT_TOKEN\",\"SLACK_SIGNING_SECRET\":\"$SLACK_SIGNING_SECRET\",\"OSCAR_BEDROCK_AGENT_ID\":\"$OSCAR_BEDROCK_AGENT_ID\",\"OSCAR_BEDROCK_AGENT_ALIAS_ID\":\"${OSCAR_BEDROCK_AGENT_ALIAS_ID:-TSTALIASID}\",\"AWS_REGION\":\"$AWS_REGION\",\"SESSIONS_TABLE_NAME\":\"${SESSIONS_TABLE_NAME:-oscar-sessions-v2}\",\"CONTEXT_TABLE_NAME\":\"${CONTEXT_TABLE_NAME:-oscar-context}\",\"ENABLE_DM\":\"${ENABLE_DM:-false}\"}"
